...
import { Upload, Download, CheckCircle2, Loader2, Trash2, FileText, X, Info, Sparkles } from 'lucide-react'

interface PDFDeletePagesTemplateProps {
  title: string
  description: string
  endpoint: string
}

export default function PDFDeletePagesTemplate({ title, description, endpoint }: PDFDeletePagesTemplateProps) {
          ...
          <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gray-900 flex items-center justify-center">
                <Trash2 size={20} className="sm:hidden text-white" strokeWidth={2} />
                <Trash2 size={24} className="hidden sm:block text-white" strokeWidth={2} />
              </div>
              <div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-blue-900">
                      ...
                      <ul className="space-y-1 text-blue-800">
                        ...
                        <li>• Enter page numbers to delete (e.g., 2,4,6)</li>
                        <li>• Download PDF without those pages</li>
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-col">
            {!result ? (
              <div className="bg-white rounded-2xl border border-gray-300 shadow-sm overflow-hidden flex-1 flex flex-col">
                <div className="border-b border-gray-200 px-6 py-4 bg-white">
                  <h2 className="text-sm font-semibold text-gray-900 uppercase tracking-wide">Pages to Delete</h2>
                </div>
                <div className="p-6 space-y-6 flex-1 flex flex-col">
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-2">Enter comma-separated page numbers to remove</p>
                  </div>
              ...
              >
                <div className="border-b border-emerald-200 px-6 py-4 bg-emerald-50">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-sm font-semibold text-emerald-900 uppercase tracking-wide">Pages Deleted</h2>
                  </div>
                </div>
                <div className="p-6">
