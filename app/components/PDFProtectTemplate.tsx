...
import { Upload, Lock, Download, CheckCircle2, Loader2, Shield, Eye, EyeOff, FileText, X, Info, Sparkles } from 'lucide-react'

interface PDFProtectTemplateProps {
  title: string
  description: string
  endpoint: string
}

export default function PDFProtectTemplate({ title, description, endpoint }: PDFProtectTemplateProps) {
        ...
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-300 shadow-sm overflow-hidden flex-1 flex items-center justify-center">
                <div className="text-center py-12">
                  <div className="inline-block mb-4">
                    <Shield size={48} className="text-gray-300" strokeWidth={1.5} />
                  </div>
          ...
          <div className="flex flex-col">
            {!result ? (
              <div className="bg-white rounded-2xl border border-gray-300 shadow-sm overflow-hidden flex-1 flex flex-col">
                <div className="border-b border-gray-200 px-6 py-4 bg-white">
                  <h2 className="text-sm font-semibold text-gray-900 uppercase tracking-wide">Password Settings</h2>
                </div>
                  ...
                  {password && (
                    <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                      ...
                      <p className="text-xs text-gray-600">
                        ...
                        {password.length >= 4 && password.length < 8 && 'Weak'}
